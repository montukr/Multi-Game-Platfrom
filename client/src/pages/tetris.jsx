...
export default function TetrisSingle() {
  ...
  async function saveScore(finalScore) {
    try {
      await api.post("/api/scores/tetris/best", { score: finalScore });
    } catch (e) {
      console.warn("Failed to save score", e);
    }
  }
  ...
  return (
    <div style={styles.shell}>
      <div style={styles.card}>
        ...
        {!gameOver && (
          <div style={styles.touchControls}>
            <button onClick={moveLeft} style={styles.touchBtn}>
              ⬅️
            </button>
            <button onClick={rotatePiece} style={styles.touchBtn}>
              🔄
            </button>
            <button onClick={moveRight} style={styles.touchBtn}>
              ➡️
            </button>
            <button onClick={moveDown} style={styles.touchBtn}>
              ⬇️
            </button>
          </div>
        )}
